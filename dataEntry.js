...
selectedRow=null;
 ...
 {
 	selectedRow.cells[0].innerHTML=employeeName;
 	selectedRow.cells[1].innerHTML=employeeId;
 	selectedRow.cells[2].innerHTML=employeeDesignation;
 	selectedRow.cells[3].innerHTML=employeeDepartment;
 	selectedRow.cells[4].innerHTML=employeeSalary;
    selectedRow.cells[5].innerHTML=employeeAddress;
